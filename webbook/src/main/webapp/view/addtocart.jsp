      ...
      <div class="container">
          ...
          <form action="/addtocart/update" method="post">
            ...
            <article class="row cart__body">
              <div class="col-6 cart__body-name">
                ...
                <a href="" class="cart__body-name-title"> ${item.name}</a>
              </div>
              ...
              <div class="col-3 cart__body-price">
                ...
                <a href="/addtocart/delete/${item.productId }">Xóa</a>
              </div>
            </article>
          </form>
        </c:forEach>
        <article class="row cart__foot">
          ...
          <span class="col-3 col-lg-3 col-sm-3 cart__foot-price">
            ...
            <button class="cart__foot-price-btn">
              <a href="/order" style="font-size: 15px; color: white"
                >Mua hàng</a
              >
            </button>
          </span>
