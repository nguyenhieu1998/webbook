...
<body>
    ...
    <section id ='category1' class="product__love">
        <div class="container">
            ...
            <div class="row bg-white">
                <c:forEach var="getProduct" items="${getProduct.content}">
                    <div class="product__panel-item col-lg-2 col-md-3 col-sm-6">
                        <div class="product__panel-img-wrap">
                           <a href="products/getProductById/${getProduct.getId()}"><img src="${getProduct.getAnhSp()}" alt="" class="product__panel-img" ></a>
                        </div>
                        <h3 class="product__panel-heading">
                            <a href="products/getProductById/${getProduct.getId()}" class="product__panel-link">${getProduct.getTenSp()}</a>
                        </h3>
        ...
        <div class="wrap">
            <a href="/home/sachviet"><button class="button">Xem thêm</button></a>
          </div>
    </section>
    ...
    <section id ='category1' class="product__love">
        ...
        <div class="wrap">
            <a href="/home/englishbook"><button class="button">Xem thêm</button></a>
          </div>
    </section>
    ...
    <section id ='category1' class="product__love">
        ...
        <div class="wrap">
            <a href="/home/manga"><button class="button">Xem thêm</button></a>
          </div>
    </section>
