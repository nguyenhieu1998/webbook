...
<body>
    ...
    <section id ='category1' class="product__love">
        <div class="container">
            ...
            <div class="row bg-white">
                <c:forEach var="getAllManga" items="${getAllManga}">
                    <div class="product__panel-item col-lg-2 col-md-3 col-sm-6">
                        <div class="product__panel-img-wrap">
                           <a href="/products/getProductById/${getAllManga.getId()}"><img src="/${getAllManga.getAnhSp()}" alt="" class="product__panel-img" ></a>
                        </div>
                        <h3 class="product__panel-heading">
                            <a href="/products/getProductById/${getAllManga.getId()}" class="product__panel-link">${getAllManga.getTenSp()}</a>
                        </h3>
