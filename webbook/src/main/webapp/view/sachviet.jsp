...
<head>
    ...
    <title>Danh mục Sách việt</title>
...
<body>
    ...
    <section id ='category1' class="product__love">
        <div class="container">
            ...
            <div class="row bg-white">
                <c:forEach var="getAllBook" items="${getAllBook}">
                    <div class="product__panel-item col-lg-2 col-md-3 col-sm-6">
                        <div class="product__panel-img-wrap">
                           <a href="/products/getProductById/${getAllBook.getId()}"><img src="/${getAllBook.getAnhSp()}" alt="" class="product__panel-img" ></a>
                        </div>
                        <h3 class="product__panel-heading">
                            <a href="/products/getProductById/${getAllBook.getId()}" class="product__panel-link">${getAllBook.getTenSp()}</a>
                        </h3>
