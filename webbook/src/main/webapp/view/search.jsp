                ...
                <c:forEach var="search" items="${search}">
                    <div class="product__panel-item col-lg-2 col-md-3 col-sm-6">
                        <div class="product__panel-img-wrap">
                           <a href="/products/getProductById/${search.getId()}"><img src="${search.getAnhSp()}" alt="" class="product__panel-img" ></a>
                        </div>
                        <h3 class="product__panel-heading">
                            <a href="/products/getProductById/${search.getId()}" class="product__panel-link">${search.getTenSp()}</a>
                        </h3>
